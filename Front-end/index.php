...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-alpha.6/js/bootstrap.min.js" integrity="sha384-vBWWzlZJ8ea9aCX4pEW3rVHjgjt7zpkNpZk+02D9phzyeVkE+jo0ieGizqPLForn" crossorigin="anonymous"></script>
 ...
 <head>
  <title>Welcome to the World of Cloud </title>
...
#Gallery {
  ...
  <body>
    ...
    <p style="color:#e0f7fa"> Welcome to Cloud Native Application </p>

    <div class="selection" style="text-align: center">
      
<div class="button">
<form action="Form.php">
  <button class="btn waves-effect waves-light btn-large bttn topleft" type="submit" name="action">Form
...
<button class="btn waves-effect waves-light btn-large bttn1 topleft1" type="submit" name="action">Gallery
